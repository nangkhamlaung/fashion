...
<div class="container mt-5 px-5">
	...
	<div class="row">
					...
					<div class="item">
						<a href="{{route('itemdetailpage',$item->id)}}">
							<div class="pad15">
								...
								<a href="#" class=" text-decoration-none addtocartBtn" data-id="{{$item->id}}" data-name="{{$item->name}}" data-photo="{{$item->photo}}" data-price="{{$item->price}}">Add to Cart</a>
		...
		<section class="customer-logos slider img-fluid mt-5">

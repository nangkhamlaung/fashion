		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    ...
		                    <div class="pad15">
								...
								<button href="" class="btn btn-primary text-decoration-none addtocartBtn" data-id="{{$item->id}}" data-name="{{$item->name}}" data-photo="{{$item->photo}}" data-price="{{$item->price}}">Add to Cart</button>

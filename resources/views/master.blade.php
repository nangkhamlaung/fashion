	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				...
				<img src="{{asset('front/image/logo/logo_big.jpg')}}" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none">

				<img src="{{asset('front/image/logo/logo_med.jpg')}}" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px">

				<img src="{{asset('front/image/logo/logo.jpg')}}" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px">
			</div>
  	...
  	<footer class="py-3 mt-5">
    	<div class="container">
    		<div class="text-center pb-3">
      		...
      		<p class="m-0 text-center text-white">Copyright &copy; <img src="{{asset('front/image/logo/logo_wh_transparent.png')}}" style="width: 30px; height: 30px"> 2019</p>
    	</div>
  	</footer>
